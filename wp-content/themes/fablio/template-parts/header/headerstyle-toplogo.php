<header id="masthead" class="<?php echo themetechmount_header_style_class(); ?> tm-header-style-infostack">
	<div class="tm-header-block <?php echo themetechmount_headerclass(); ?>">
		...
		<?php get_template_part('template-parts/header/header','main-toplogo'); ?>
