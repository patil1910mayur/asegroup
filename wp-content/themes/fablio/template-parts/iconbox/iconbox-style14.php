...
?>
<div class="themetechmount-iconbox themetechmount-iconbox-stylesix themetechmount-iconbox-<?php echo themetechmount_sanitize_html_classes($tm_global_iconbox_element_values['view']); ?> <?php echo themetechmount_sanitize_html_classes($tm_global_iconbox_element_values['main-class']); ?>">
	<div class="themetechmount-iconbox-inner tm-iconstyle-<?php echo themetechmount_wp_kses($tm_global_iconbox_element_values['icon_bg_style']);  ?>">
