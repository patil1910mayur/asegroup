...
<div class="tm-fid inside tm-fid-view-lefticon <?php echo themetechmount_sanitize_html_classes($tm_global_fid_element_values['main-class']); ?>">
	<div class="tm-fid-left">
		<?php echo themetechmount_wp_kses($tm_global_fid_element_values['lefticoncode'], 'fid_icon'); ?>
		<div class="tm-fidicon"><h4 class="tm-fid-inner">
		...
		</span><?php echo themetechmount_wp_kses($tm_global_fid_element_values['after_text']); ?>
		</h4>
		</div>
	</div>
