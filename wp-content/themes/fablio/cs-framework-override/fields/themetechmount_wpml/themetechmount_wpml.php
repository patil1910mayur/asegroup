...
class CSFramework_Option_themetechmount_wpml extends CSFramework_Options {
  ...
  public function output(){
	...
	$config['box_title']		= esc_attr__( 'Multilingual Fablio Theme', 'fablio' );
	$config['name']				= esc_attr( 'Fablio' ); //name of theme/plugin
	$config['box_description']	= esc_attr__('Fablio theme is fully compatible with WPML - the WordPress Multilingual plugin. WPML lets you add languages to your existing sites and includes advanced translation management.', 'fablio' );
