...
class CSFramework_Option_themetechmount_iconpicker extends CSFramework_Options {
  ...
  public function output(){
	...
	$icon_library_array = array( // all icon library list array
		'themify'        => array( esc_attr__( 'Themify icons', 'fablio' ), 'ti-location-pin'),
		'linecons'       => array( esc_attr__( 'Linecons', 'fablio' ), 'li_star'),
		'kw_fablio'     => array( esc_attr__( 'Fablio Icons', 'fablio' ), 'flaticon-fruits'),
	);
	...
	$icon_picker_html    = '';
	$icon_dropdown_array = array( esc_attr__( 'Font Awesome', 'fablio' )    => 'fontawesome' );
