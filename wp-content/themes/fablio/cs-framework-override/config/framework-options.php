...
$tm_framework_options[] = array(
	...
	'fields' => array( // begin: fields
		...
		array(
			...
			'letter-spacing' => true, // Defaults to false
			'all-varients'   => false,
			'output'      => 'h4,.themetechmount-box-blog .themetechmount-box-content h4,.themetechmount-box-service .themetechmount-box-title h4,.themetechmount-iconbox-styleeleven .themetechmount-iconbox-heading .tm-vc_general h2,.themetechmount-teambox-style2.style3 .themetechmount-box-title h4', // An array of CSS selectors to apply this font style to dynamically
			'units'       => 'px', // Defaults to px
			'default'     => array(
				'family'			=> 'Rubik',
				'backup-family'		=> 'Arial, Helvetica, sans-serif',
...
$tm_framework_options[] = array(
	...
	'fields' => array( // begin: fields
		...
		array(
			...
			'default'		 => '#1a2227',
			'dependency'  	 => array( 'header_bg_color|header_style', '==|any', 'custom|classic,classic3,classic-overlay,centerlogo-overlay,toplogo-overlay,classic-box-overlay,classic-box-overlay-rtl,classic-overlay-rtl,infostack-overlay,infostack-overlay-rtl,classic-highlight' ),//Multiple dependency
		...
		array(
			...
			'dependency'  	 => array( 'header_style', 'any', 'classic,classic2,classic3,classic-overlay,classic-box-overlay,classic-rtl,classic-overlay-rtl,toplogo,toplogo-overlay,centerlogo,centerlogo-overlay,infostack,infostack-rtl,infostack-overlay,infostack-overlay-rtl,classic-vertical,classic-highlight' ), // This dependency was not working normally so had to define radio to it with attributes id more on this link https://github.com/Codestar/codestar-framework/issues/52
		...
		array(
			...
			'dependency'  	 => array( 'header_style', 'any', 'classic,classic3,classic-box-overlay' ),
        ),
		array(
			'id'       		 => 'header_text',
			'type'     		 => 'textarea',
			...
			'shortcode'		 => true,
			'dependency'  	 => array( 'header_style', 'any', 'classic,classic2,classic3,classic-box-overlay,classic-overlay,classic-rtl,classic-overlay-rtl,classic-highlight' ), // This dependency was not working normally so had to define radio to it with attributes id more on this link https://github.com/Codestar/codestar-framework/issues/52
		...
		array(
			...
			'default'       => 'right',
			'dependency'  	=> array( 'header_style', 'any', 'classic,classic2,classic3,classic-overlay,classic-highlight,classicinfo' ),
...
$tm_framework_options[] = array(
	...
	'fields' => array( // begin: fields
		...
		array(
			...
			'type'    => 'themetechmount_iconpicker',
			'title'  		=> esc_attr__('Big icon', 'fablio' ),
			'after'  		=> '<div class="cs-text-muted"><br>'.esc_attr__('Select icon that appear in top with big size', 'fablio').'</div>',
			'default' =>  array (
				'library'			  => 'fontawesome',
