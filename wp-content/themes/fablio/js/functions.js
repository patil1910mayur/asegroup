/**
 * Functionality specific to Fablio.
 *
...
function fablio_logMarginPadding(){
	/**************/
	jQuery('.wpb_column').each(function(){
		if( jQuery(this).hasClass('tm-left-span') ){
			...
			randomclass     = 'fablio-random-class-' + randomclass;
...
function fablio_logMarginPadding_content(){
...
function fablio_circle_progress_counter(){
...
// Top btn click event
	...
	jQuery('#site-header-menu #site-navigation div.nav-menu > ul > li:has(ul), .tm-mmmenu-override-yes #site-header-menu #site-navigation .mega-menu-wrap > ul > li:has(ul)').append("<span class='righticon'><i class='tm-fablio-icon-angle-down'></i></span>");	
	...
	jQuery('.righticon').on('click', function() {
		if(jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').hasClass('open')){
			...
			jQuery( 'i', jQuery(this) ).removeClass('tm-fablio-icon-angle-up').addClass('tm-fablio-icon-angle-down');
		} else {
			jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').addClass('open');			
			jQuery( 'i', jQuery(this) ).removeClass('tm-fablio-icon-angle-down').addClass('tm-fablio-icon-angle-up');
		}
		return false;
 	});
	...
	fablio_circle_progress_counter();
	...
	/* Logo Margin Padding
	/*------------------------------------------------------------------------------*/
	fablio_logMarginPadding();
	fablio_logMarginPadding_right();
	fablio_logMarginPadding_content();		
	/*------------------------------------------------------------------------------*/
...
jQuery(window).load(function(){
	...
	( function() {
		...
		jQuery( '.menu-toggle' ).on( 'click.fablio', function() {
...
var tm_stretched_col = function() {
	...
	jQuery('.elementor-top-section.elementor-section').each(function(){
