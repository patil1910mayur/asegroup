...
$allParams = array_merge(
		...
		array( 
			...
			array(
				...
				"description" => sprintf( esc_attr__("How many %s item you want to show.", "fablio"), $pf_type_title ),
				"param_name"  => "show",
				"value"       => array(
			...
			array(
				...
				"description" => sprintf( esc_attr__("Show sortable category links above %s items so user can sort by just single click.",'fablio'), $pf_type_title_singular ),
				"param_name"  => "sortable",
				"value"       => array(
			...
			array(
				...
				"description" => sprintf( esc_attr__("Show pagination links below %s boxes.",'fablio'), $pf_type_title ),
			...
			array(
				"type"        => "checkbox",
				"heading"     => sprintf( esc_attr__("From %s", "fablio"), $pf_cat_title_singular ),
				"description" => sprintf( esc_attr__('If you like to show %1$s from selected %2$s than select the category here.', "fablio"), $pf_type_title, $pf_cat_title ),				
				"param_name"  => "category",
...
vc_map( array(
	"name"     => sprintf( esc_attr__("ThemetechMount %s Box",'fablio'), $pf_type_title_singular ),
