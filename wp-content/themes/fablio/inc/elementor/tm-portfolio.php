...
class Fablio_Portfoliobox_Widget extends Widget_Base{
	...
	public function get_title() {
		return esc_attr__( 'Portfolio Box Element', 'fablio' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Portfolio Style', 'fablio' ),
				'description'	=> esc_attr__( 'Select Portfolio style.', 'fablio' ),
				...
				'options' => [
					...
					'style4'	=> esc_attr( 'PortfolioBox Style 4' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_attr__( 'Our Work', 'fablio' ),
...
// Register widget
Plugin::instance()->widgets_manager->register_widget_type( new Fablio_Portfoliobox_Widget() );