...
class Fablio_Clientbox_Widget extends Widget_Base{
	...
	public function get_title() {
		return esc_attr__( 'Client Logo Box', 'fablio' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Client View Style', 'fablio' ),
				'description'	=> esc_attr__( 'Select Client View style.', 'fablio' ),
				...
				'options' => [
					...
					'greyscale-logo'	=> esc_attr( 'greyscale-logo' ),
				],
		...
		$this->start_controls_section(
			'data_section',
			[
				'label' => esc_attr__( 'Data Design', 'fablio' ),
			]
		);
...
// Register widget
Plugin::instance()->widgets_manager->register_widget_type( new Fablio_Clientbox_Widget() );