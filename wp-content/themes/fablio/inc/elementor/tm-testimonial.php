...
class Fablio_Testimonialbox_Widget extends Widget_Base{
	...
	public function get_title() {
		return esc_attr__( 'Testimonial Box', 'fablio' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Testimonial Style', 'fablio' ),
				'description'	=> esc_attr__( 'Select View style.', 'fablio' ),
				...
				'options' => [
					...
					'style-4'	=> esc_attr( 'TestimonialBox Style 4' ),
					'style-5'	=> esc_attr( 'TestimonialBox Style 5' ),
					'style-6'	=> esc_attr( 'TestimonialBox Style 6' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_attr__( 'Testimonials', 'fablio' ),
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_attr__( 'Show sub-heding before heading', 'fablio' ),
		...
		$this->add_responsive_control(
			'text_align',
			[
				'label' => esc_attr__( 'Alignment', 'fablio' ),
		...
		$this->add_control(
			...
			[
				...
				'options'		=> [
					...
					'slickview'		=> esc_attr__( 'Slick Style One Column Carousel', 'fablio' ),
				]
			]
		);
		...
		$this->add_control(
			'carousel_options',
			[
				'label' => esc_attr__( 'Carousel Options', 'fablio' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
		...
		$this->add_control(
			'tm-loop',
			[
				'label'			=> esc_attr__( 'Carousel: Loop', 'fablio' ),
				'description'	=> esc_attr__( 'Infinity loop. Duplicate last and first items to get loop illusion.', 'fablio' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> '0',
				'options'		=> [
		...
		$this->add_control(
			...
			[
				...
				'description'	=> esc_attr__( 'Autoplay of carousel.', 'fablio' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> '0',
				'options'		=> [
					'1'				=> esc_attr__( 'Yes', 'fablio' ),
		...
		$this->add_control(
			'tm-centermode',
			[
				'label'			=> esc_attr__( 'Carousel: Center', 'fablio' ),
				'description'	=> esc_attr__( 'Center item. Works well with even an odd number of items.', 'fablio' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> '0',
				'options'		=> [
					'1'				=> esc_attr__( 'Yes', 'fablio' ),
		...
		$this->add_control(
			...
			[
				...
				'description'	=> esc_attr__( 'Show arrow navigation.', 'fablio' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> '0',
				'options'		=> [
					'1'				=> esc_attr__( 'Yes', 'fablio' ),
		...
		$this->add_control(
			...
			[
				...
				'description'	=> esc_attr__( 'Show dots navigation.', 'fablio' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> '0',
				'options'		=> [
					'1'				=> esc_attr__( 'Yes', 'fablio' ),
		...
		$this->add_control(
			...
			[
				...
				'description'	=> esc_attr__( 'autoplay speed.', 'fablio' ),
		...
		$this->add_control(
			...
			[
				...
				'description'	=> esc_attr__( 'Select how many column to show.', 'fablio' ),
				'type' => Controls_Manager::SELECT,
				'label_block'	=> true,
				'thumb_width'	=> '110px',
				'default'		=> 'one',
		...
		if ( $posts->have_posts() ) {
			...
			<div class="themetechmount-box-heading-wrapper <?php echo themetechmount_wp_kses($headingclass); ?>">
				...
				if( function_exists('themetechmount_get_filterbutton') ){
					$sortable_category_html = themetechmount_get_filterbutton( $settings, 'tm_testimonial_group' );
			...
			if( !empty($slick_type) && $slick_type == 'slickview' ){
				...
				$footer             = '';
						...
						echo themetechmount_wp_kses($startwrapper.
						$infowrapper.
							$content.
						$infowrapperend.
						$footerwrapper.
...
// Register widget
Plugin::instance()->widgets_manager->register_widget_type( new Fablio_Testimonialbox_Widget() );