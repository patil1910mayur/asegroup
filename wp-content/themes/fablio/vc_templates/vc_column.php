 ...
 */
$el_class = $el_id = $width = $parallax_speed_bg = $parallax_speed_video = $parallax = $parallax_image = $video_bg = $video_bg_url = $video_bg_parallax = $css = $offset = $css_animation = $tm_col_expand_chcontent ='';
...
if( !empty($tm_col_bg_expand) && in_array( $tm_col_bg_expand, array('left','right') ) ){  // Left expand or Right expand
	$css_classes[] = 'tm-span tm-' . $tm_col_bg_expand . '-span' . ' tm-expandcontent-' . $tm_col_expand_chcontent;
}
