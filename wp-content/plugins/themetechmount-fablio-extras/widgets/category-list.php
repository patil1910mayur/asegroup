 ...
 * @since 1.0
 */
class fablio_category_list_widget extends WP_Widget {
	...
	public function __construct() {
		$widget_style = array('classname'   => 'fablio_category_list_widget',
							  'description' => esc_attr__('Show Category List of current Taxonomy.', 'fablio') );
		parent::__construct(
			'fablio_category_list_widget', // Base ID
			esc_attr__('Fablio Category/Group List Widget', 'fablio'), // Name
			$widget_style // Args
		);
	}
...
register_widget( 'fablio_category_list_widget' );