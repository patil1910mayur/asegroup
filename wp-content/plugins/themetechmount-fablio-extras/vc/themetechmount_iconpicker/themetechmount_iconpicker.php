...
/**** Icon Libraries ****/
function themetechmount_fablio_enqueue_icon_libraries(){
...
add_action( 'wp_enqueue_scripts', 'themetechmount_fablio_enqueue_icon_libraries' );
 ...
 */
function themetechmount_fablio_admin_scripts_styles() {
	...
	// iconset-themify
	wp_enqueue_script( 'iconset-kw_fablio', TMTE_URI . '/vc/themetechmount_iconpicker/iconset-kw_fablio.js', array( 'bootstrap' ) );
	
	
	// Bootstrap icon picker
	wp_enqueue_script( 'bootstrap-iconpicker', get_template_directory_uri().'/inc/assets/bootstrap-iconpicker/js/bootstrap-iconpicker.js', array( 'bootstrap', 'iconset-fontawesome', 'iconset-linecons', 'iconset-themify', 'iconset-kw_fablio' ) );
	...
	// iconset-kw_fablio
	wp_enqueue_style( 'kw_fablio', get_template_directory_uri().'/assets/themetechmount-fablio-extra-icons/font/flaticon.css' );
...
add_action( 'admin_enqueue_scripts', 'themetechmount_fablio_admin_scripts_styles' );
